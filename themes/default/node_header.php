<header class="object node">
	...
	<nav class="crud">
		<ul>
			...
			?>
			<li class="edit"><a class="button edit" href="<?php __(_e($node->getEditPath())); ?>" title="<?php __(_a('edit_node_button_title', $node->getTitle())); ?>"><?php __(_m('edit_node_button_text')); ?></a></li>
			<li class="view"><a class="button view" href="<?php __(_e($node->getPath())); ?>" title="<?php __(_a('view_node_button_title', $node->getTitle())); ?>"><?php __(_m('view_node_button_text')); ?></a></li>
			<?php
