		...
		<footer class="object node">
			<section class="edges">
				...
				<nav class="collection edges <?php __class('edges-' . $edge_schema->getName()); ?>">
					<ul>
						<li class="new"><a class="button new" href="<?php __($node->getNewEdgePath($edge_schema)); ?>" title="<?php __(_m('new_edge_title', $edge_schema->getName(), $node->getTitle())); ?> "><?php __(_m('new_edge_link_text')); ?></a></li>
						<?php
