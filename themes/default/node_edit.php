...
<form class="update node node-<?php __class($node_schema->getName()); ?>" action="<?php __($action_uri); ?>" method="POST">
	<?php
...
<form class="delete node node-<?php __class($node_schema->getName()); ?>" action="<?php __($action_uri); ?>" method="POST">
